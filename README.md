...
7. Setup environment variables in zshrc file. To find the **ID**, **Token**, and **Secret**: 
	...
	3. Choose the **Credentials** button to retrieve the Token and Secret. 
	4. Add the following to the zshrc file. The Bandwidth and Catapult credentials are the same: 
